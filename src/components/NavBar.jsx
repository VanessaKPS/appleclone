...
const NavBar = () => {
  ...
  return (
    <nav class='nav-bar'>
      <ul class='nav-links'>
        <li class='apple-icon-wrapper'>
          <NavBarIcon className={isMenuIconClicked? 'apple-icon' :'hide'} href='https://www.apple.com/uk/'  width="14" height="44" viewBox="0 0 16 44">
        ...
        <div className={ !isMenuIconClicked?'menu-items-wrapper':'expandable-menu-items-wrapper'}>
          ...
          <a className='menu-item' href='https://www.apple.com/uk/mac/'>Mac</a>
          <a className='menu-item' href='https://www.apple.com/uk/ipad/'>iPad</a>
          <a className='menu-item' href='https://www.apple.com/uk/iphone/'>iPhone</a>
          <a className='menu-item' href='https://www.apple.com/uk/watch/'>Watch</a>
          <a className='menu-item' href='https://www.apple.com/uk/tv/'>TV</a>
          <a className='menu-item' href='https://www.apple.com/uk/music/'>Music</a>
          <a className='menu-item' href='https://support.apple.com/en-gb'>Support</a>
        </div>
        
        <li class='search-icon-wrapper' ><NavBarIcon className='search-icon'  href='https://www.apple.com/uk/search' width="14" height="44" viewBox="0 0 16 44">
        ...
        <li class='bag-icon-wrapper'><NavBarIcon className='bag-icon' href='https://www.apple.com/uk/shop/bag'  width="15" height="44" viewBox="0 0 17 44">
